...
static void runAutotests() {
    ...
    p += runTest(0,NULL,-2,"Test 2: l = X | n = non-existant\n");
    int a[1] = {1};
    p += runTest(1,a,-1,"Test 3: l = 1->X | n = NULL\n");
    p += runTest(1,a,-2,"Test 4: l = 1->X | n = non-existant\n");
    p += runTest(1,a,0, "Test 5: l = 1->X | n = l->head\n");
    int b[3] = {1,2,3};
    p += runTest(3,b,-1,"Test 6: l = 1->2->3->X | n = NULL\n");
    p += runTest(3,b,-2,"Test 7: l = 1->2->3->X | n = non-existant\n");
    ...
    p += runTest(3,c,-2,"Test 12: l = 1->1->1->X | n = non-existant\n");
    ...
    p += runTest(2,d,-2,"Test 17: l = 1->5->X | n = non-existant\n");
